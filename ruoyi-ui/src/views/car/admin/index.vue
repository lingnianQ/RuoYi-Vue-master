<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="adminList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" prop="adminid" />
...
<script>
import { listAdmin, getAdmin, delAdmin, addAdmin, updateAdmin } from "@/api/car/admin";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('car/admin/export', {
        ...this.queryParams

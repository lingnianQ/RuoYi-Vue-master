...
CREATE TABLE `t_admin` (
                           `adminId` int(11) NOT NULL AUTO_INCREMENT comment '编号',
                           `adminName` varchar(255) DEFAULT NULL comment '名称',
                           `adminPassword` varchar(255) DEFAULT NULL comment '密码',
                           PRIMARY KEY (`adminId`)
...
CREATE TABLE `t_rizhi` (
                           `rizhiId` int(11) NOT NULL AUTO_INCREMENT comment '编号',
                           `rizhiName` varchar(255) NOT NULL comment '名称',
                           `dengluIp` varchar(255) NOT NULL comment '登录ip',
                           `date` datetime NOT NULL comment '日期',
                           PRIMARY KEY (`rizhiId`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 comment '日志';
...
CREATE TABLE `t_shangpin` (
                              `shangpinId` int(11) NOT NULL AUTO_INCREMENT comment '编号',
                              `shangpinName` varchar(255) DEFAULT NULL comment '商品名称',
                              `shangpinMark` varchar(255) DEFAULT NULL comment '商品标志0',
                              `shangpinMark1` varchar(255) DEFAULT NULL comment '商品标志1',
                              `shangpinMark2` varchar(255) DEFAULT NULL comment '商品标志2',
                              `shangpinMark3` varchar(255) DEFAULT NULL comment '商品标志3',
                              `shangpinDate` datetime DEFAULT NULL comment '日期',
                              `shangpinDate1` datetime DEFAULT NULL comment '日期2',
                              `shangpinZong` int(11) DEFAULT NULL comment '商品库存',
                              `shangpinJin` double DEFAULT NULL comment '商品价格',
                              `shangpinXiao` double DEFAULT NULL comment '商品销量',
                              `shangpinLirun` double DEFAULT NULL comment '商品利润',
                              `shangpinType` int(11) DEFAULT NULL comment '商品类型',
                              `shangpinType1` int(11) DEFAULT NULL comment '商品类型2',
                              `shangpinImg` varchar(255) DEFAULT NULL comment '商品图片',
                              `shangpinImgName` varchar(255) DEFAULT NULL comment '商品图片名',
                              `sptypeId` int(11) DEFAULT NULL comment '类型编号',
                              `sptypeName` varchar(255) DEFAULT NULL comment '类型名',
                              `userId` int(11) DEFAULT NULL comment '用户编号',
                              `userName` varchar(255) DEFAULT NULL comment '用户名',
                              `bumenId` int(11) DEFAULT NULL comment '部门编号',
                              `bumenName` varchar(255) DEFAULT NULL comment '部门名称',
...
CREATE TABLE `t_spcangku` (
                              `spcangkuId` int(11) NOT NULL AUTO_INCREMENT comment '编号',
                              `spcangkuName` varchar(255) DEFAULT NULL comment '车牌',
                              `spcangkuMark` varchar(255) DEFAULT NULL comment '标志1',
                              `spcangkuMark1` varchar(255) DEFAULT NULL comment '标志2',
                              `spcangkuMark2` varchar(255) DEFAULT NULL comment '标志3',
                              `spcangkuPhone` varchar(255) DEFAULT NULL comment '标志4',
                              `spcangkuDizhi` varchar(255) DEFAULT NULL comment '地址',
                              `spcangkuDate` datetime DEFAULT NULL comment '日期',
                              `spcangkuDate1` datetime DEFAULT NULL comment '日期1',
                              `spcangkuType` int(11) DEFAULT NULL comment '类型',
                              `spcangkuType1` int(11) DEFAULT NULL comment '类型1',
...
CREATE TABLE `t_spgys` (
                           ...
                           PRIMARY KEY (`spgysId`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 comment '员工信息';
...
CREATE TABLE `t_spjin` (
                           ...
                           PRIMARY KEY (`spjinId`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 comment '地址信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 comment '区域信息';
